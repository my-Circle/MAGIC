...
class TokenLabelConverter(object):
    ...
    def __init__(self, opt):
        ...
        self.wp_tokenizer = BertTokenizer.from_pretrained('bert/')
    ...
    def wp_encode(self, text):
        wp_target = self.wp_tokenizer(text, padding='max_length', max_length=self.batch_max_length, truncation=True,
                                      return_tensors="pt")
